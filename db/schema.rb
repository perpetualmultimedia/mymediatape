...
ActiveRecord::Schema.define(version: 20180604082647) do
  ...
  create_table "band_avatars", force: :cascade do |t|
    t.integer  "band_id"
    t.string   "format"
    t.datetime "created_at",          null: false
    t.datetime "updated_at",          null: false
    ...
    t.index ["band_id"], name: "index_band_avatars_on_band_id", using: :btree
  end
  ...
  add_foreign_key "band_avatars", "bands"
