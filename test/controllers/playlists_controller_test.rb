...
class PlaylistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create playlist" do
    assert_difference('Playlist.count') do
      post playlists_url, params: { playlist: { title: @playlist.title, user: @playlist.user } }
    end
  ...
  test "should update playlist" do
    patch playlist_url(@playlist), params: { playlist: { title: @playlist.title, user: @playlist.user } }
