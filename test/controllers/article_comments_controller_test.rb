...
class ArticleCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create article_comment" do
    assert_difference('ArticleComment.count') do
      post article_comments_url, params: { article_comment: { article_id: @article_comment.article_id, body: @article_comment.body, user_id: @article_comment.user_id } }
    end
  ...
  test "should update article_comment" do
    patch article_comment_url(@article_comment), params: { article_comment: { article_id: @article_comment.article_id, body: @article_comment.body, user_id: @article_comment.user_id } }
