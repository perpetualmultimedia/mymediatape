class Album < ActiveRecord::Base
  ...
  has_attached_file :album_art, :s3_protocol => :https, :url =>':s3_domain_url',
  :path => '/:class/:attachment/:id_partition/:style/:filename', styles: { medium: "300x300>", thumb: "100x100>" }, default_url: "/images/:style/missing.png"
